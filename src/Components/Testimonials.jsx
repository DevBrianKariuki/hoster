  ...
  return (
    <div className='w-full mt-12 py-12 items-center overflow-hidden flex flex-col'>
      <div className='flex items-center gap-3 pb-8 flex-col'>
        ...
        <p data-aos='zoom-in-up'  className='font-inter text-md text-gray-300'>Your trusted hosting partner since 2005. Here's what some of our customers say about HOST.CO.IN</p>
      </div>
...
const ClientCard = ({id, avatar, name, testimony, rating}) =>(
  <div className='flex w-[30%] mt-8 items-center flex-col'>
